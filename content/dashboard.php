...
<div style="text-align: center; margin-bottom: 20px;">
    <h1 style="color: #280872; font-size: 30px; margin-bottom: 10px;">Selamat Datang di Aplikasi Manajemen Pegawai Kafe Biru</h1>
...
<div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap;">
    <div style="flex: 1; margin-right: 20px; max-width: 400px;">
        <div style="background: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            <h2 style="color: #280872; margin-bottom: 15px;">Jumlah Pegawai</h2>
            <?php
    ...
    <div style="flex: 1; max-width: 400px;">
        <div style="background: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            <h2 style="color: #280872; margin-bottom: 15px;">Jumlah Jabatan</h2>
            <?php
